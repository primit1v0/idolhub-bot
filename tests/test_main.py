...
@patch("main.initialize_config")
@patch("main.setup_logging")
@patch("main.TelegramBot")
def test_main_dispatch_bot_default(mock_bot_class, mock_setup_logging, mock_initialize_config, mock_cfg):
    mock_initialize_config.return_value = mock_cfg
...
@patch("main.setup_logging")
@patch("uvicorn.run")
def test_main_dispatch_api_cli(mock_uvicorn_run, mock_setup_logging, mock_initialize_config, mock_cfg):
    mock_initialize_config.return_value = mock_cfg
...
def test_main_dispatch_mcp_cli(mock_run_mcp, mock_setup_logging, mock_initialize_config, mock_cfg):
    mock_initialize_config.return_value = mock_cfg
